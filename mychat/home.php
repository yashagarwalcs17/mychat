			...
			<div class="col-md-3 col-sm-3 col-xs-12 left-sidebar">
				<div class="input-group searchbox">
					<div class="input-group-btn">
						<center><a href="include/find_friends.php"><button class="btn btn-default search-icon" name="search_user" type="submit">Add/Settingss</button></a></center>
					</div>
				</div>
				<div class="left-chat">
					<ul>
			...
			<div class="col-md-9 col-sm-9 col-xs-12 right-sidebar">
				...
				<div class="row">
					<div id="scrolling_to_bottom" class="col-md-12 right-header-contentChat">
						...
						if($user_name == $sender_username or $username == $receiver_username){
						...
						else if($user_name == $receiver_username or $username == $sender_username){
							echo"
								<li>
