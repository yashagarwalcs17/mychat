...
<div class="signup-form">
    <form action="" method="post">
        ...
        <div class="form-group">
        	...
        	<input type="text" class="form-control" placeholder="Example: user" name="user_name" autocomplete="off" required="required">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
        	...
        	<input type="email" class="form-control" placeholder="user@gmail.com" name="user_email" autocomplete="off" required="required">
        </div>
        <div class="form-group">
			<label>Country</label>
